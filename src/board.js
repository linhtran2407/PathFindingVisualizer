// const Node = require("./PathFindingVisualizer/Node/Node");
...
//         if (!this.numberOfObjects) {
//           success = dijkstraAlgorithm
//         (this.nodes, this.start, this.target, this.nodesToAnimate, this.boardArray, this.currentAlgorithm, this.currentHeuristic);
//           launchAnimations(this, success, "weighted");
//         } else {
//           this.isObject = true;
//           success = dijkstraAlgorithm
//         (this.nodes, this.start, this.object, this.objectNodesToAnimate, this.boardArray, this.currentAlgorithm, this.currentHeuristic);
...
//         if (!this.numberOfObjects) {
//           success = undijkstraAlgorithm
//         (this.nodes, this.start, this.target, this.nodesToAnimate, this.boardArray, this.currentAlgorithm);
//           launchAnimations(this, success, "unweighted");
//         } else {
//           this.isObject = true;
//           success = undijkstraAlgorithm
//         (this.nodes, this.start, this.object, this.objectNodesToAnimate, this.boardArray, this.currentAlgorithm);
